...
const MetadataPanel: React.FC = () => {
  ...
  console.log('Current Metadata:', metadata); // Added console log for debugging

  if (!metadata) return null;

  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg p-4 overflow-y-auto">
